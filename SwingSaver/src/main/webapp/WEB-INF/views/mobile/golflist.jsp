...
<section id="contents">
    ...
    <div class="bud-tab">
        <a href="#" class="tab-01 active">모두</a>
        <a href="#" class="tab-01">제휴</a>
    </div>
    <div class="list-wrap">
        <div class="list">
            <img src="/mobile/image/buddyya-off.png" class="list-img" width="100%">
            <div class="list-info">
                <img src="/mobile/image/golf-logo.png" class="list-logo">
                <h4>아시아나컨트리클럽</h4>
                <p>경기남부</p>
            </div>
        ...
        <div class="list">
            <img src="/mobile/image/buddyya-on.png" class="list-img" width="100%">
            <div class="list-info">
                <img src="/mobile/image/golf-logo.png" class="list-logo">
                <h4>아시아나컨트리클럽</h4>
                <p>경기남부</p>
            ...
            <div class="list-right">
                <img src="/mobile/image/like-off.svg" class="list-like" width="100%">
