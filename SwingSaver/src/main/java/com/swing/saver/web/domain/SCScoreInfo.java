...
public class SCScoreInfo {
	...
	private Integer     storke1;
	private Integer     storke2;
	private Integer     storke3;
	private Integer     storke4;
	private Integer     storke5;
	private Integer     storke6;
	private Integer     storke7;
	private Integer     storke8;
	private Integer     storke9;
	private Integer     storke10;
	private Integer     storke11;
	private Integer     storke12;
	private Integer     storke13;
	private Integer     storke14;
	private Integer     storke15;
	private Integer     storke16;
	private Integer     storke17;
	private Integer     storke18;
	...
	public SCScoreInfo(ScoreRequest scoreVo)
	{
		...
		this.storke1 = Strings.isNullOrEmpty(scoreVo.getStroke1()) == true ? null : Integer.parseInt(scoreVo.getStroke1());
		this.storke2 = Strings.isNullOrEmpty(scoreVo.getStroke2()) == true ? null : Integer.parseInt(scoreVo.getStroke2());
		this.storke3 = Strings.isNullOrEmpty(scoreVo.getStroke3()) == true ? null : Integer.parseInt(scoreVo.getStroke3());
		this.storke4 = Strings.isNullOrEmpty(scoreVo.getStroke4()) == true ? null : Integer.parseInt(scoreVo.getStroke4());
		this.storke5 = Strings.isNullOrEmpty(scoreVo.getStroke5()) == true ? null : Integer.parseInt(scoreVo.getStroke5());
		this.storke6 = Strings.isNullOrEmpty(scoreVo.getStroke6()) == true ? null : Integer.parseInt(scoreVo.getStroke6());
		this.storke7 = Strings.isNullOrEmpty(scoreVo.getStroke7()) == true ? null : Integer.parseInt(scoreVo.getStroke7());
		this.storke8 = Strings.isNullOrEmpty(scoreVo.getStroke8()) == true ? null : Integer.parseInt(scoreVo.getStroke8());
		this.storke9 = Strings.isNullOrEmpty(scoreVo.getStroke9()) == true ? null : Integer.parseInt(scoreVo.getStroke9());
		this.storke10 = Strings.isNullOrEmpty(scoreVo.getStroke10()) == true ? null : Integer.parseInt(scoreVo.getStroke10());
		this.storke11 = Strings.isNullOrEmpty(scoreVo.getStroke11()) == true ? null : Integer.parseInt(scoreVo.getStroke11());
		this.storke12 = Strings.isNullOrEmpty(scoreVo.getStroke12()) == true ? null : Integer.parseInt(scoreVo.getStroke12());
		this.storke13 = Strings.isNullOrEmpty(scoreVo.getStroke13()) == true ? null : Integer.parseInt(scoreVo.getStroke13());
		this.storke14 = Strings.isNullOrEmpty(scoreVo.getStroke14()) == true ? null : Integer.parseInt(scoreVo.getStroke14());
		this.storke15 = Strings.isNullOrEmpty(scoreVo.getStroke15()) == true ? null : Integer.parseInt(scoreVo.getStroke15());
		this.storke16 = Strings.isNullOrEmpty(scoreVo.getStroke16()) == true ? null : Integer.parseInt(scoreVo.getStroke16());
		this.storke17 = Strings.isNullOrEmpty(scoreVo.getStroke17()) == true ? null : Integer.parseInt(scoreVo.getStroke17());
		this.storke18 = Strings.isNullOrEmpty(scoreVo.getStroke18()) == true ? null : Integer.parseInt(scoreVo.getStroke18());
