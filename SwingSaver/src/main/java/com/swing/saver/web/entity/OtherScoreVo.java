...
/**
 * 개인별 동반자 스코어 정보 클래스 
 * Table Name : SCSCOREWITHINFO
 * @author minso
 *
 */
public class OtherScoreVo {
	private String visit_date;
	private String countryclub_id;				// 골프장 코드
	private int seq_no;							// 라운드 예정  key
	private int user_id;						// 사용자 시퀀스 key
	private int order_no;						// 순서번호
	private String visit_nm;					// 플레이어 이름
	private int score1;
	private int score2;
	private int score3;
	private int score4;
	...
	public void setVisit_nm(String visit_nm) {
		this.visit_nm = visit_nm;
	}
