...
<input type="hidden" name="country_id" value="${areaInfo.country_id}">
<input type="hidden" name="zone_id" value="${areaInfo.zone_id}">
</form>
            <div class="content" style="margin-bottom: 0;">
                <div class="no-padding adm-con" >  
                    <h2 class="right-tit">지역정보 상세</h2>
                    <div class="sub-mem-list">
                    <h4 class="sub-tit">지역정보</h4>
                    <div class="sub-g-btn">
                            ...
                            <table summary="This table shows how to create responsive tables using Bootstrap's default functionality" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>${areaInfo.country_id}</td>
                                    </tr>                                    
                                    <tr>
                                        <td><strong>지역코드</strong></td>
                                        <td>${areaInfo.zone_id}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>지역명</strong></td>
                                        <td>${areaInfo.zone_nm}</td>
                                    </tr>                                    
                                    <tr>
                                        <td><strong>지역담당자</strong></td>
                                        <td>${areaInfo.user_name}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>주소</strong></td>
                                        <td>${areaInfo.address}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>연락처
                                        </strong></td>
                                        <td>${areaInfo.phone}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>이메일</strong></td>
                                    <td>${areaInfo.email}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>비고</strong></td>
                                        <td>${areaInfo.description}</td>
                                    </tr>                                    
