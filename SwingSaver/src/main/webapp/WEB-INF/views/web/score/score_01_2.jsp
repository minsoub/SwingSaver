                        ...
                        <div class="sc-search">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="course_td">
                                                                     출발&ensp;
                                        <select id="start_course" name="start_course" onchange="javascript:changeParInfo1(this.value);">
                                            <option value="">OUT 코스 선택</option>
                                        </select>
                                        &emsp;도착&ensp;
                                        <select id="end_course" name="end_course" onchange="javascript:changeParInfo2(this.value);">
...
$(document).ready(function(){
	...
	// 출발 코스가 변경되었을 때 변경된 코스로 Par 정보를 조회해서 HTML을 구성한다. 
	function changeParInfo1(data)
	{
		if (data == "") return;
		url = "/score/parDetail/"+$("#country_id").val()+"/"+$("#zone_id").val()+"/"+$("#countryclub_id").val()+"/"+data;
		method = "GET";
	    $.ajax({
	        type: method,
	        url : url,
	        ...
	        success : function(rtnData) {
	            ...
	            if(typeof (reqdata) === 'object'){	     
	            	$('#hole1').text(reqdata.hole1);
	            	$('#hole2').text(reqdata.hole2);
	            	$('#hole3').text(reqdata.hole3);
	            	$('#hole4').text(reqdata.hole4);
	            	$('#hole5').text(reqdata.hole5);
	            	$('#hole6').text(reqdata.hole6);
	            	$('#hole7').text(reqdata.hole7);
	            	$('#hole8').text(reqdata.hole8);
	            	$('#hole9').text(reqdata.hole9);
	            }
	        },
	        error: function(jqXHR, textStatus, errorThrown) {
	            console.log(jqXHR.responseText);
	...
	// 종료 코스가 변경되었을 때 변경된 코스로 Par 정보를 조회해서 HTML을 구성한다. 
	function changeParInfo2(data)
	{
		if (data == "") return;
	    ...
	    $.ajax({
	        ...
	        success : function(rtnData) {
	            ...
	            if(typeof (reqdata) === 'object'){	     
	            	$('#hole10').text(reqdata.hole1);
	            	$('#hole11').text(reqdata.hole2);
	            	$('#hole12').text(reqdata.hole3);
	            	$('#hole13').text(reqdata.hole4);
	            	$('#hole14').text(reqdata.hole5);
	            	$('#hole15').text(reqdata.hole6);
	            	$('#hole16').text(reqdata.hole7);
	            	$('#hole17').text(reqdata.hole8);
	            	$('#hole18').text(reqdata.hole9);
	            }
	        },
	        error: function(jqXHR, textStatus, errorThrown) {
	            console.log(jqXHR.responseText);
